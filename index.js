...
// Global variable to track the current alert ID
let alertCounter = 1;
...
app.post('/webhook', async (req, res) => {
  ...
  try {
    ...
    // Generate a sequential alert ID starting from 1
...
async function sendEmail(alertId, title, message) {
  ...
  const footer = `<br><br><strong><em>This Alert is Generated By Software Factory Team</em></strong>
                  <br><img src="https://lh3.googleusercontent.com/proxy/FvREM8G67ewAKxLkvhh_AATEmzp-vWVjD56_FnVpa_mMIXO_U9RCD-BWt9jEfz4SweHARPCH0JwJjPsjbcYMwXtl0SWa55P85g3QUatN-kwSkpml9rvgJ5tSrQ" alt="Software Factory Logo" width="150" height="75" />
                  <br><strong>Alert ID:</strong> ${alertId}`; // Adding Alert ID in the footer
  ...
  console.log(`Email sent successfully to EMAIL_TO and EMAIL_TO_1. Alert ID: ${alertId}`);
}
