...
async function sendEmail(title, message) {
  ...
  // Add a custom footer at the end with an embedded image
  const footer = `<br><br><strong><em>This Alert is Generated By Software Factory Team</em></strong>
                  <br><img src="https://pbs.twimg.com/profile_images/1806585361566687232/gMKYXGSl_400x400.jpg" alt="Software Factory Logo" width="100" height="50" />`;
  ...
  const mailOptions = {
    ...
    html: `<p><strong>Title:</strong> <b>${title}</b></p>
           ...
           ${footer}`, // Adding the footer and logo to the email
  };
